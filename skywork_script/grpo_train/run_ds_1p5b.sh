...
OUTPUT_DIR="./outputs/skywork_orz_ds_1p5b_ckpt"

python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=["./skywrok_data/Skywork-Orz-Rl-data/train_1p5b.pkl"] \
    ...
    trainer.experiment_name="skywork_orz_ds_1p5b" \
